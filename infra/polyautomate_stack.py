...
SCRIPT""",
            ...
            "echo '* * * * * root bash -lc \"set -a; source /etc/polyautomate-portfolio.env; set +a; /usr/local/bin/publish-portfolio-dashboard.sh >> /var/log/polyautomate-portfolio.log 2>&1\"' > /etc/cron.d/polyautomate-portfolio",
            "chmod 644 /etc/cron.d/polyautomate-portfolio",
            "echo portfolio_publisher_userdata_version=4",
            "bash -lc 'set -a; source /etc/polyautomate-portfolio.env; set +a; /usr/local/bin/publish-portfolio-dashboard.sh >> /var/log/polyautomate-portfolio.log 2>&1' || true",
